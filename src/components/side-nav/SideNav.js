...
export const SideNav = props => {
  ...
  let childrenWithNewProps = React.Children.map(props.children, child =>
    React.cloneElement(child, { className: "link link__hidden" })
  );
  ...
  return (
    <div
      id="sideNav"
      className={`side-nav ${
        sidenav.visible ? "side-nav__active" : "side-nav__hidden"
      }`}
    >
      <a onClick={toggleDropDown} href="#" className={`dropdown`}>
      ...
      <a
        ...
        className={`side-nav__btn-close ${
          sidenav.visible
            ? "side-nav__btn-close--active"
            : "side-nav__btn-close--hidden"
        }`}
      ...
      <a
        ...
        className={`side-nav__btn-open ${
          sidenav.visible
            ? "side-nav__btn-open--hidden"
            : "side-nav__btn-open--active"
        }`}
        id="open-button"
      >
